...
export class Rewards {
    ...
    selectReward(reward) {
        if (reward.type === "stat") {
            if (reward.id === "heal") this.game.healPlayer(30);
            if (reward.id === "maxhp") {
                this.game.maxHp += 10;
                this.game.healPlayer(10);
            }
            if (reward.id === "full") this.game.healPlayer(1000);
            if (reward.id === "shield") this.game.shield += 20;
            if (reward.id === "gold") this.game.gold += 40;
        } else if (reward.type === "artifact") {
            this.game.addArtifact(reward);
        }
